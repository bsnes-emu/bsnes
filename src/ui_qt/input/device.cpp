...
InputDevice::InputDevice(SNES::System::Input::DeviceID i, bool p, const char *n) : InputGroup(n), id(i), port(p) {
}
...
int16_t Joypad::state(unsigned index) const {
  ...
  switch(index) {
    case SNES::System::Input::JoypadUp:     return up.state;
    case SNES::System::Input::JoypadDown:   return down.state;
    case SNES::System::Input::JoypadLeft:   return left.state;
    case SNES::System::Input::JoypadRight:  return right.state;
    case SNES::System::Input::JoypadA:      return a.state;
    case SNES::System::Input::JoypadB:      return b.state;
    case SNES::System::Input::JoypadX:      return x.state;
    case SNES::System::Input::JoypadY:      return y.state;
    case SNES::System::Input::JoypadL:      return l.state;
    case SNES::System::Input::JoypadR:      return r.state;
    case SNES::System::Input::JoypadSelect: return select.state;
    case SNES::System::Input::JoypadStart:  return start.state;
  }

  return 0;
}

Joypad::Joypad(SNES::System::Input::DeviceID id, bool port, const char *name,
...
int16_t Mouse::state(unsigned index) const {
  switch(index) {
    case SNES::System::Input::MouseX:     return x.state;
    case SNES::System::Input::MouseY:     return y.state;
    case SNES::System::Input::MouseLeft:  return left.state;
    case SNES::System::Input::MouseRight: return right.state;
  }

  return 0;
}

Mouse::Mouse(SNES::System::Input::DeviceID id, bool port, const char *name,
...
int16_t SuperScope::state(unsigned index) const {
  switch(index) {
    case SNES::System::Input::SuperScopeX:       return x.state;
    case SNES::System::Input::SuperScopeY:       return y.state;
    case SNES::System::Input::SuperScopeTrigger: return trigger.state;
    case SNES::System::Input::SuperScopeCursor:  return cursor.state;
    case SNES::System::Input::SuperScopeTurbo:   return turbo.state;
    case SNES::System::Input::SuperScopePause:   return pause.state;
  }

  return 0;
}

SuperScope::SuperScope(SNES::System::Input::DeviceID id, bool port, const char *name,
...
int16_t Justifier::state(unsigned index) const {
  switch(index) {
    case SNES::System::Input::JustifierX:       return x.state;
    case SNES::System::Input::JustifierY:       return y.state;
    case SNES::System::Input::JustifierTrigger: return trigger.state;
    case SNES::System::Input::JustifierStart:   return start.state;
  }

  return 0;
}

Justifier::Justifier(SNES::System::Input::DeviceID id, bool port, const char *name,
...
InputDevice* InputDevicePool::find(SNES::System::Input::DeviceID id) {
...
Joypad joypad1(SNES::System::Input::DeviceIDJoypad1, InputDevice::Port1, "Joypad",
...
Joypad joypad2(SNES::System::Input::DeviceIDJoypad2, InputDevice::Port2, "Joypad",
...
Joypad multitap1a(SNES::System::Input::DeviceIDMultitap1A, InputDevice::Port1, "Multitap - Port 1",
...
Joypad multitap1b(SNES::System::Input::DeviceIDMultitap1B, InputDevice::Port1, "Multitap - Port 2",
...
Joypad multitap1c(SNES::System::Input::DeviceIDMultitap1C, InputDevice::Port1, "Multitap - Port 3",
...
Joypad multitap1d(SNES::System::Input::DeviceIDMultitap1D, InputDevice::Port1, "Multitap - Port 4",
...
Joypad multitap2a(SNES::System::Input::DeviceIDMultitap2A, InputDevice::Port2, "Multitap - Port 1",
...
Joypad multitap2b(SNES::System::Input::DeviceIDMultitap2B, InputDevice::Port2, "Multitap - Port 2",
...
Joypad multitap2c(SNES::System::Input::DeviceIDMultitap2C, InputDevice::Port2, "Multitap - Port 3",
...
Joypad multitap2d(SNES::System::Input::DeviceIDMultitap2D, InputDevice::Port2, "Multitap - Port 4",
...
Mouse mouse1(SNES::System::Input::DeviceIDMouse1, InputDevice::Port1, "Mouse",
config.input.mouse1.x, config.input.mouse1.y, config.input.mouse1.left, config.input.mouse1.right);

Mouse mouse2(SNES::System::Input::DeviceIDMouse2, InputDevice::Port2, "Mouse",
config.input.mouse2.x, config.input.mouse2.y, config.input.mouse2.left, config.input.mouse2.right);

SuperScope superscope(SNES::System::Input::DeviceIDSuperScope, InputDevice::Port2, "Super Scope",
...
Justifier justifier1(SNES::System::Input::DeviceIDJustifier1, InputDevice::Port2, "Justifier 1",
config.input.justifier1.x,       config.input.justifier1.y,
config.input.justifier1.trigger, config.input.justifier1.start);

Justifier justifier2(SNES::System::Input::DeviceIDJustifier2, InputDevice::Port2, "Justifier 2",
