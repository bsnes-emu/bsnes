#define p00(__color) *(out0 + 0) = (colortbl[__color])
#define p01(__color) *(out0 + 1) = (colortbl[__color])
#define p10(__color) *(out1 + 0) = (colortbl[__color])
#define p11(__color) *(out1 + 1) = (colortbl[__color])
